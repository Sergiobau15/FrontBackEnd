...
const App = (props) => {
  const {
    ...
    currentPage, totalPages, setCurrentPage, modalVisible, modalMessage, modalTitle, setModalVisible
  } = props;
      ...
      <main className="flex-1 p-8">
        ...
        <form onSubmit={handleOrderSubmit}>
          ...
          <div className="flex justify-end gap-4">
            <button type="submit" className="px-6 py-2 bg-green-500 text-white rounded-md hover:bg-blue-600">
              Registrar Pedido
            </button>
            <button
              type="button"
